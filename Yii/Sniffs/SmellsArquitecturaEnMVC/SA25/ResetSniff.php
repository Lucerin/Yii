 ...
 */
class Yii_Sniffs_SmellsArquitecturaEnMVC_SA25_ResetSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$stackPtr]['content'] === 'reset') {
           ...
           //Limpia el comando y se prepara para la construcción de una nueva consulta.
